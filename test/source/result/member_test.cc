...
TEST(Result, member)
{
    ...
    };
    {
...

        {
            ...
            ::remotePortMapper::Result<TestStruct, void> value;
            ASSERT_DEATH(value.value<TestStruct>(), ".*");
            ...
            // Copy elision
            auto value1 = ::remotePortMapper::Result<TestStruct, void>::makeOk(
                value.value<TestStruct>());
    ...
    }
    {
...

        {
            ...
            ::remotePortMapper::Result<void, TestStruct> value;
            ASSERT_DEATH(value.value<TestStruct>(), ".*");
            ASSERT_FALSE(value.good());
            ASSERT_FALSE(value.ok());
            ASSERT_FALSE(value);
            ...
            // Copy elision
            auto value1
                = ::remotePortMapper::Result<void, TestStruct>::makeError(
                    value.value<TestStruct>());
            ASSERT_TRUE(value1.good());
